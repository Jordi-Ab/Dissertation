# -*- coding: utf-8 -*-
"""
Toolbox for generating a mesh, developed for working with MeshPy by Juergen Weizenecker
	See: https://github.com/inducer/meshpy/blob/master/examples/jw_meshtools.py
More information about MeshPy
	See: https://documen.tician.de/meshpy/
"""
import numpy as np
import scipy as sp
...
# Straight line
def LineSegments(P1,P2,num_points=3,edge_length=-1):
